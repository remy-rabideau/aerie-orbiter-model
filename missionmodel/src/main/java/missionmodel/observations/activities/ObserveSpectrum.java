...
/**
 * SPECTROSCOPY observation -- disperses light to measure a spectrum.
 *
 * Maps to ACROSS ObservationType.SPECTROSCOPY. Parameters map to ACROSS fields:
 *   targetName               -> object_name
 *   ra, dec                  -> pointing_position
 *   exposure                 -> exposure_time
 *   emResPower               -> em_res_power (spectral resolving power R = lambda/dlambda)
 *   energyMinKev/energyMaxKev-> bandpass (EnergyBandpass)
 *   description              -> description
 */
@ActivityType("ObserveSpectrum")
public class ObserveSpectrum {
